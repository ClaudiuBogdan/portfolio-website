...
const text = en.components.header
          ...
          >
            <div className="flex flex-row-reverse items-center justify-between">
              <Popover.Button aria-label="Close menu" className="-m-1 p-1">
                <CloseIcon className="h-6 w-6 text-zinc-500 dark:text-zinc-200" />
              </Popover.Button>
              <h2 className="text-sm font-medium text-zinc-600 dark:text-zinc-200">
                {text.nav.navigation}
              </h2>
            </div>
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                <MobileNavItem href="/about">{text.nav.about}</MobileNavItem>
                ...
                <MobileNavItem href="/uses">{text.nav.uses}</MobileNavItem>
              </ul>
            </nav>
          </Popover.Panel>
        </Transition.Child>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/about">{text.nav.about}</NavItem>
        <NavItem href="/articles">{text.nav.articles}</NavItem>
        <NavItem href="/projects">{text.nav.projects}</NavItem>
